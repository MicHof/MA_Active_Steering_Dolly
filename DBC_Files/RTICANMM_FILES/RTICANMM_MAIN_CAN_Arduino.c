/*****************************************************************************************************************************/
/* MAIN S-FUNCTION for RTICANMM MainBlock (RTICANMM_MAIN_CAN_Arduino.c) */
/*                                                                                                                           */
/*   AUTHOR(S):                                                                                                              */
/*      U. Homann                                                                                                              */
/*      M. Eikermann                                                                                                              */
...
#include "RTICANMM_MAIN_CAN_Arduino_Globals.h"                                                                                                              
...
#define CANMM_CONTROLLER_ID CANMM_CTL_SETUP_Controller3                                                                                             
...
{                                                                                                                      
  ...
  static Int32 StartIdx[2] = {0, 3};                                                                                 
  static Int32 StopIdx[2]  = {2, 2};                                                                                 
  static Int32 NumOfIds[2] = {3, 0};                                                                                 
  Int32 MsgId = Msg->Id;                                                                                               
...
{                                                                                                                          
  ...
  void **PWork = ssGetPWork(S);                                                                                            
      ...
      msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_MDL_START_INFO , RTICANMM_MAINSFCN_MDL_START_INFO_TXT, "CAN_Arduino");  
#endif                                                                                                                     
    ...
    while (CANMM_CTL_RX(CANMM_CONTROLLER_ID, &ctlsetup_client, &MsgData.CANMsg)) {                                            
      ...
      if(!MsgData.CANMsg.Loopback) {                                                                                       
        msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_RX_LOOPBACK_INFO,                                                
                        RTICANMM_MAINSFCN_RX_LOOPBACK_INFO_TXT, "CAN_Arduino",                                                      
                        MsgData.CANMsg.Id,                                                                                 
        ...
        msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_RX_MSG_INFO, RTICANMM_MAINSFCN_RX_MSG_INFO_TXT, "CAN_Arduino",            
                        MsgData.CANMsg.Id,                                                                                 
                        MsgData.CANMsg.TimeStamp,                                                                          
                        MsgData.CANMsg.Dlc,                                                                                
                        MsgData.CANMsg.Data[0]);                                                                           
      ...
      if (idIdx != -1) {                                                                                           
        ...
        CANMMCAN_Arduino_RXt[idIdx] = MsgData.CANMsg.TimeStamp;                   
        if (MsgData.CANMsg.Loopback) {                          
          CANMMCAN_Arduino_RXdt[idIdx] = MsgData.CANMsg.TimeStamp - TX_OLDTIME[idIdx];
          TX_OLDTIME[idIdx] = MsgData.CANMsg.TimeStamp;         
          CANMMCAN_Arduino_RXsta[idIdx] = 1;                                    
        }                                                       
        else {                                                  
          CANMMCAN_Arduino_RXdt[idIdx] = MsgData.CANMsg.TimeStamp - RX_OLDTIME[idIdx];
