...
#
#  $RCSfile: CAN_Communication.mk $ $Revision: 2.76 $ $Date: 2014/02/25 16:00:51MEZ $
...
COMPUTER                       = PCWIN64
MODEL                          = CAN_Communication
MODULES                        = CAN_Communication_data.c CAN_Communication_rticanmm.c CAN_Communication_trc_ptr.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
S_FUNCTIONS                    = RTICANMM_SETUP_Controller1.c RTICANMM_MAIN_CAN.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
RTWCUST_INCLUDES = \
	$(START_DIR)\CAN_Communication_rti1401 \
	$(START_DIR) \
