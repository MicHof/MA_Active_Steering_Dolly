/************************ dSPACE target specific file *************************
   ...
   Include file .\CAN_Communication_rti1401\CAN_Communication_th.c :

   Task Configuration file for model : CAN_Communication

   RTI1401 7.2 (02-May-2014)/2.5
   13-Jan-2015 20:02:17
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\CAN_Communication_rti1401\CAN_Communication_th.c is for ST).
# endif
