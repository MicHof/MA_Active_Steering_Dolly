...
#
#  $RCSfile: CAN_new.mk $ $Revision: 2.76 $ $Date: 2014/02/25 16:00:51MEZ $
...
COMPUTER                       = PCWIN64
MODEL                          = CAN_new
MODULES                        = CAN_new_data.c CAN_new_rticanmm.c CAN_new_trc_ptr.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
S_FUNCTIONS                    = RTICANMM_MAIN_CAN.c RTICANMM_SETUP_Controller1.c RTICANMM_MAIN_CAN_Arduino.c RTICANMM_SETUP_Controller3.c RTICANMM_SETUP_Controller2.c RTICANMM_MAIN_CAN_2.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\Sebastian\Documents\GitHub\MA_Active_Steering_Dolly\DBC_Files
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = CAN_newlib.lib
...
RTWCUST_INCLUDES = \
	$(START_DIR)\CAN_new_rti1401 \
	$(START_DIR) \
	$(START_DIR)\RTICANMM_FILES \
	..\RTICANMM_FILES \
	C:\PROGRA~1\DSPACE~1\MATLAB\RTICANMM\C
...
TMP_PATH_CC += C:\PROGRA~1\DSPACE~1\MATLAB\RTICANMM\TLC
TMP_PATH_CC += ..\RTICANMM_FILES
