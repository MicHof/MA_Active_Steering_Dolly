...
#define S_FUNCTION_NAME        RTICANMM_SETUP_TutVar_C1                                                                                          
...
#include "RTICANMM_SETUP_TutVar_C1.h"                                                                                                    
...
static Float64 CANMM_CTL_SETUP_TutVar_C1_baudrate      = 500.0;                                                                                 
static Float64 CANMM_CTL_SETUP_TutVar_C1_baudrate_in   = 500.0; /* Temporary for input port value */                                            
static Float64 CANMM_CTL_SETUP_TutVar_C1_baudrate_old  = 500.0;                                                                                 
#endif /* RTICANMM_HAVE_VALID_PLATFORM */                                                                           
...
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_ID;                                                                                     
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_TX_STATUS        = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_Variation        = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_VariationSwitch  = 0;                                                                   
...
#endif                                                                                                             
volatile UInt8   CANMMMonitor_TutVar_C1     = 0;                                                                                       
volatile UInt8   CANMMMonitor_TutVar_C1_old = 0;                                                                                       
volatile dsfloat MonitoringTimeStamp_TutVar_C1     = 0.0;                                                                                     
...
static CANMM_CTL_CLIENT_TYPE(CANMM_CTL_SETUP_TutVar_C1) ctlsetup_client;                                                                  
#endif /* RTICANMM_DSDAQ_SERVICEID */                                                                              
                                                                                                                   
#if !defined(RTICANMM_HAVE_DSCAN_CHANNEL)                                                                          
void CANMM_CTL_SETUP_TutVar_C1_baudrate_set(Float64 baudrate) {                                                                           
...
void DECLSPEC CANMM_CTL_SETUP_TutVar_C1_client_init(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client) {                                                               
  ...
  if (!client->initialized) {                                                                                      
    ...
    if ((Error = DsCanMsg_setQueueSize(client->tx_msg, CANMM_CTL_SETUP_TutVar_C1_tx_queue_size)) != DSCAN_NO_ERROR)                       
      CANMM_DEBUG_ERROR(Error);                                                                                    
 ...
 * available.                                                                                                      
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_rx(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client, CanMM_Msg* msg) {                                                       
 ...
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_tx(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client, CanMM_Msg* msg) {                                                       
  int      k     = 0;                                                                                              
  DsTError Error = DSCAN_NO_ERROR;                                                                                 
  DsSCanMsg_Item msg_item;                                                                                         
 ...
 * If CANMM_CTL_SETUP_TutVar_C1_rx_stop has been issued before, the receive buffer (mcr) is cleared                                       
 * for the calling client. Messages received in the inactive period thus will                                      
 * not be received.                                                                                                
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_TutVar_C1_rx_start(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client) {                                                                  
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
 ...
 * CANMM_CTL_SETUP_TutVar_C1_rx function. To continue reception of messages CANMM_CTL_SETUP_TutVar_C1_rx_start                                                   
 * has to be called.                                                                                               
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_TutVar_C1_rx_stop(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client) {                                                                   
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
...
Float64 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_baudrate_get() {                                                                               
  return CANMM_CTL_SETUP_TutVar_C1_baudrate;                                                                                              
}                                                                                                                  
...
*/                                                                                                                 
UInt32 DECLSPEC CANMM_CTL_SETUP_TutVar_C1_tx_queue_level(CANMM_CTL_SETUP_TutVar_C1_CtlClient* client) {                                                          
  UInt32   tx_count = 0;                                                                                           
  DsTError Error;                                                                                                  
  ...
  if ((Error = DsCanMsg_getTxQueueCount(client->tx_msg, &tx_count)) != DSCAN_NO_ERROR) {                           
    ...
    tx_count = CANMM_CTL_SETUP_TutVar_C1_tx_queue_size;                                                                                   
  }                                                                                                                
  return tx_count;                                                                                                 
}                                                                                                                  
...
/****************************/                                                                                     
  ...
  if ((Error = DsCanCh_setDescriptor(CanMM_channel, "TutVar_C1")) != DSCAN_NO_ERROR)                                      
    CANMM_DEBUG_ERROR(Error);                                                                                      
                                                                                                                   
  if ((Error = DsCanCh_setBaudRate(CanMM_channel, (int)CANMM_CTL_SETUP_TutVar_C1_baudrate*1000)) != DSCAN_NO_ERROR)                       
      CANMM_DEBUG_ERROR(Error);                                                                                    
...
# else                                                                                                             
    ...
    DsCanBoard_create(&CanMM_board, CAN_BOARD_BASE);                                                               
         ...
         CanMM_channel = ds4302_can_channel_init(CAN_BOARD_BASE,                                                   
                                         CAN_CHANNELNO-1,                                                  
                                         CANMM_CTL_SETUP_TutVar_C1_baudrate * 1000,                                               
                                         CAN_TYPE_MB15,                                                    
                                         CAN_CHANNELNO-1);                                                 
...
#if defined(RTICANMM_DSDAQ_SERVICEID)                                                                                   
    CANMM_CTL_CLIENT_INIT(CANMM_CTL_SETUP_TutVar_C1, &ctlsetup_client);                                                                   
    CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_TutVar_C1, &ctlsetup_client);      /* Start disabled */                                             
#endif                                                                                                             
...
#if defined(TJA)                                                                                               
    /******************************************* SST ********************************/                         
    CANMM_CTL_SETUP_TutVar_C1_TX_STATUS = (INDEF_TJA1041STATUS == TJA1041_NORMAL)                                                     
...
# endif                                                                                                            
    ...
    if (CANMM_CTL_SETUP_TutVar_C1_VariationSwitch == 0) {                                                                                 
        CANMM_CTL_SETUP_TutVar_C1_ID = INDEF_VARIATION;                                                                                   
    }                                                                                                              
    else {                                                                                                         
        CANMM_CTL_SETUP_TutVar_C1_ID = CANMM_CTL_SETUP_TutVar_C1_Variation;                                                                                      
    }                                                                                                              
...
# endif /* CANMM_HOST_DEBUG */                                                                                                
#if defined(RTICANMM_DSDAQ_SERVICEID)                                                                                 
if (CANMMMonitor_TutVar_C1 > 0 && !(CANMMMonitor_TutVar_C1_old > 0)) { /* monitoring enabled */                                                          
  CANMM_CTL_RX_START(CANMM_CTL_SETUP_TutVar_C1, &ctlsetup_client);                                                                      
}                                                                                                                
if (!(CANMMMonitor_TutVar_C1 > 0) && CANMMMonitor_TutVar_C1_old > 0) { /* monitoring disabled */                                                         
  CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_TutVar_C1, &ctlsetup_client);                                                                       
}                                                                                                                
CANMMMonitor_TutVar_C1_old = CANMMMonitor_TutVar_C1;                                                                                                     
                                                                                                                 
if (CANMMMonitor_TutVar_C1 > 0) {                                                                                                    
  while (CANMM_CTL_RX(CANMM_CTL_SETUP_TutVar_C1, &ctlsetup_client, &canmm_msg)) {                                                       
    int i = 0;                                                                                                   
    ...
    MonitoringTimeStamp_TutVar_C1 = canmm_msg.TimeStamp;                                                                                    
