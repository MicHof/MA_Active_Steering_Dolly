/************************ dSPACE target specific file *************************
   ...
   Include file .\demo_simplemodel_rti1401\demo_simplemodel_th.c :
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\demo_simplemodel_rti1401\demo_simplemodel_th.c is for ST).
# endif
